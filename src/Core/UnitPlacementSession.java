...
public class UnitPlacementSession {
    ...
    /**
     * Creates a new placement session with the given unit blueprints.
     *
     * @param unitBlueprints the available unit types the player can choose from
     */
    ...
    /**
     * Returns the list of available unit blueprints.
     *
     * @return unit blueprints
     */
